...
window.onscroll = function () {
    ...
    if (distanceScrolled > 100) {
        ...
        navbar.innerHTML = ` <ul><li><a style="color: rgb(239, 119, 54); font-weight:500; " href="#home">home</a></li>  
            ...
            <li><a style="color: rgb(239, 119, 54); font-weight:500;" href="#about">about</a></li>
            </ul>`;
        ...
        navbar.innerHTML = ` <ul> <li><a href="#home">home</a></li> <li><a href="#middle-h">services</a></li><li><a href="#team">team</a></li> <li><a href="#about">about</a></li></ul>`
